...
class GhidraAgent(BaseAgent):
    ...
    def _build_analysis_prompt(
        ...
        parts = [
            ...
            "",
            "## ⚠️ MANDATORY: You MUST use decompile_function tool",
            ...
            "- If you don't call decompile_function, analyzed_functions will be EMPTY = FAILURE",
            "- Call decompile_function for at least 3-5 key functions",
            "",
            "## Binary Information",
        ...
        parts.extend(
            [
                ...
                "- You MUST call decompile_function for key functions",
        ...
        parts.extend(
            [
                ...
                "- Call list_functions to see available functions",
                "- Identify main, _start, or exported functions",
                "",
                "### Step 2: Decompile key functions (MANDATORY)",
                "- Call decompile_function for entry points",
                "- Call decompile_function for suspicious functions",
                "- You MUST decompile at least 3-5 functions",
                "",
                "### Step 3: Trace call chains",
                "- Call function_xrefs to understand relationships",
